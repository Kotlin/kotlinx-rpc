...
public class ApiInternal : com.google.protobuf.kotlin.Api,
...
public class MethodInternal : com.google.protobuf.kotlin.Method,
...
public class MixinInternal : com.google.protobuf.kotlin.Mixin,
    kotlinx.rpc.protobuf.internal.InternalMessage(fieldsWithPresence = 0) {
    @kotlinx.rpc.internal.utils.InternalRpcApi
    public override val _size: Int by lazy { computeSize() }
...
@kotlinx.rpc.internal.utils.InternalRpcApi
public fun com.google.protobuf.kotlin.ApiInternal.Companion.decodeWith(
    msg: com.google.protobuf.kotlin.ApiInternal,
...
private fun com.google.protobuf.kotlin.ApiInternal.computeSize(): Int {
    ...
    if (version.isNotEmpty()) {
        __result += kotlinx.rpc.protobuf.internal.WireSize.string(version).let {
            kotlinx.rpc.protobuf.internal.WireSize.tag(
                4,
                kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED
            ) + kotlinx.rpc.protobuf.internal.WireSize.int32(it) + it
...
public fun com.google.protobuf.kotlin.Api.asInternal(): com.google.protobuf.kotlin.ApiInternal {
    return this as? com.google.protobuf.kotlin.ApiInternal
...
@kotlinx.rpc.internal.utils.InternalRpcApi
public fun com.google.protobuf.kotlin.MethodInternal.Companion.decodeWith(
    msg: com.google.protobuf.kotlin.MethodInternal,
    decoder: kotlinx.rpc.protobuf.internal.WireDecoder,
) {
    while (true) {
        val tag = decoder.readTag() ?: break // EOF, we read the whole message
...
private fun com.google.protobuf.kotlin.MethodInternal.computeSize(): Int {
    ...
    if (requestTypeUrl.isNotEmpty()) {
        __result += kotlinx.rpc.protobuf.internal.WireSize.string(requestTypeUrl).let {
            kotlinx.rpc.protobuf.internal.WireSize.tag(
                2,
                kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED
            ) + kotlinx.rpc.protobuf.internal.WireSize.int32(it) + it
    ...
    if (requestStreaming != false) {
        __result += (kotlinx.rpc.protobuf.internal.WireSize.tag(
            3,
            kotlinx.rpc.protobuf.internal.WireType.VARINT
        ) + kotlinx.rpc.protobuf.internal.WireSize.bool(requestStreaming))
    }

    if (responseTypeUrl.isNotEmpty()) {
        __result += kotlinx.rpc.protobuf.internal.WireSize.string(responseTypeUrl).let {
            kotlinx.rpc.protobuf.internal.WireSize.tag(
                4,
                kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED
            ) + kotlinx.rpc.protobuf.internal.WireSize.int32(it) + it
    ...
    if (responseStreaming != false) {
        __result += (kotlinx.rpc.protobuf.internal.WireSize.tag(
            5,
            kotlinx.rpc.protobuf.internal.WireType.VARINT
        ) + kotlinx.rpc.protobuf.internal.WireSize.bool(responseStreaming))
    }
...
public fun com.google.protobuf.kotlin.Method.asInternal(): com.google.protobuf.kotlin.MethodInternal {
    return this as? com.google.protobuf.kotlin.MethodInternal
        ?: error("Message ${this::class.simpleName} is a non-internal message type.")
}
...
@kotlinx.rpc.internal.utils.InternalRpcApi
public fun com.google.protobuf.kotlin.MixinInternal.Companion.decodeWith(
    msg: com.google.protobuf.kotlin.MixinInternal,
    decoder: kotlinx.rpc.protobuf.internal.WireDecoder,
) {
    while (true) {
        val tag = decoder.readTag() ?: break // EOF, we read the whole message
...
private fun com.google.protobuf.kotlin.MixinInternal.computeSize(): Int {
    ...
    if (root.isNotEmpty()) {
        __result += kotlinx.rpc.protobuf.internal.WireSize.string(root).let {
            kotlinx.rpc.protobuf.internal.WireSize.tag(
                2,
                kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED
            ) + kotlinx.rpc.protobuf.internal.WireSize.int32(it) + it
...
public fun com.google.protobuf.kotlin.Mixin.asInternal(): com.google.protobuf.kotlin.MixinInternal {
    return this as? com.google.protobuf.kotlin.MixinInternal
        ?: error("Message ${this::class.simpleName} is a non-internal message type.")
}
