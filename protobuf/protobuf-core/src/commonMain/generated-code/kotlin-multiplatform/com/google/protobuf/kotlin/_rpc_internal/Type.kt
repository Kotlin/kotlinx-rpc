...
public class TypeInternal : com.google.protobuf.kotlin.Type,
...
public class FieldInternal : com.google.protobuf.kotlin.Field,
...
public class EnumInternal : com.google.protobuf.kotlin.Enum,
    kotlinx.rpc.protobuf.internal.InternalMessage(fieldsWithPresence = 1) {
    private object PresenceIndices {
        public const val sourceContext: Int = 0
    }
...
public class EnumValueInternal : com.google.protobuf.kotlin.EnumValue,
    kotlinx.rpc.protobuf.internal.InternalMessage(fieldsWithPresence = 0) {
    @kotlinx.rpc.internal.utils.InternalRpcApi
    public override val _size: Int by lazy { computeSize() }
...
public class OptionInternal : com.google.protobuf.kotlin.Option,
    kotlinx.rpc.protobuf.internal.InternalMessage(fieldsWithPresence = 1) {
    private object PresenceIndices {
...
@kotlinx.rpc.internal.utils.InternalRpcApi
public fun com.google.protobuf.kotlin.TypeInternal.Companion.decodeWith(
    msg: com.google.protobuf.kotlin.TypeInternal,
    ...
    while (true) {
        ...
        when {
            ...
            tag.fieldNr == 5 && tag.wireType == kotlinx.rpc.protobuf.internal.WireType.START_GROUP -> {
                ...
                decoder.readMessage(
                    msg.sourceContext.asInternal(),
                    com.google.protobuf.kotlin.SourceContextInternal::decodeWith
                )
            }
...
private fun com.google.protobuf.kotlin.TypeInternal.computeSize(): Int {
    ...
    if (presenceMask[0]) {
        __result += sourceContext.asInternal()._size.let {
            kotlinx.rpc.protobuf.internal.WireSize.tag(
                5,
                kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED
            ) + kotlinx.rpc.protobuf.internal.WireSize.int32(it) + it
    ...
    if (syntax != com.google.protobuf.kotlin.Syntax.SYNTAX_PROTO2) {
        ...
        ) + kotlinx.rpc.protobuf.internal.WireSize.enum(syntax.number))
    }

    if (edition.isNotEmpty()) {
        __result += kotlinx.rpc.protobuf.internal.WireSize.string(edition).let {
            kotlinx.rpc.protobuf.internal.WireSize.tag(
                7,
                kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED
            ) + kotlinx.rpc.protobuf.internal.WireSize.int32(it) + it
...
public fun com.google.protobuf.kotlin.Type.asInternal(): com.google.protobuf.kotlin.TypeInternal {
    return this as? com.google.protobuf.kotlin.TypeInternal
...
@kotlinx.rpc.internal.utils.InternalRpcApi
public fun com.google.protobuf.kotlin.FieldInternal.Companion.decodeWith(
...
private fun com.google.protobuf.kotlin.FieldInternal.computeSize(): Int {
    ...
    if (kind != com.google.protobuf.kotlin.Field.Kind.TYPE_UNKNOWN) {
        __result += (kotlinx.rpc.protobuf.internal.WireSize.tag(
            1,
            kotlinx.rpc.protobuf.internal.WireType.VARINT
        ) + kotlinx.rpc.protobuf.internal.WireSize.enum(kind.number))
    }
    ...
    if (cardinality != com.google.protobuf.kotlin.Field.Cardinality.CARDINALITY_UNKNOWN) {
        __result += (kotlinx.rpc.protobuf.internal.WireSize.tag(
            2,
            kotlinx.rpc.protobuf.internal.WireType.VARINT
        ) + kotlinx.rpc.protobuf.internal.WireSize.enum(cardinality.number))
    }
    ...
    if (number != 0) {
        __result += (kotlinx.rpc.protobuf.internal.WireSize.tag(
            3,
            kotlinx.rpc.protobuf.internal.WireType.VARINT
        ) + kotlinx.rpc.protobuf.internal.WireSize.int32(number))
    }
    ...
    if (oneofIndex != 0) {
        __result += (kotlinx.rpc.protobuf.internal.WireSize.tag(
            7,
            kotlinx.rpc.protobuf.internal.WireType.VARINT
        ) + kotlinx.rpc.protobuf.internal.WireSize.int32(oneofIndex))
    }
    ...
    if (packed != false) {
        __result += (kotlinx.rpc.protobuf.internal.WireSize.tag(
            8,
            kotlinx.rpc.protobuf.internal.WireType.VARINT
        ) + kotlinx.rpc.protobuf.internal.WireSize.bool(packed))
    }
    ...
    if (jsonName.isNotEmpty()) {
        __result += kotlinx.rpc.protobuf.internal.WireSize.string(jsonName).let {
            kotlinx.rpc.protobuf.internal.WireSize.tag(
                10,
                kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED
            ) + kotlinx.rpc.protobuf.internal.WireSize.int32(it) + it
    ...
    if (defaultValue.isNotEmpty()) {
        __result += kotlinx.rpc.protobuf.internal.WireSize.string(defaultValue).let {
            kotlinx.rpc.protobuf.internal.WireSize.tag(
                11,
                kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED
            ) + kotlinx.rpc.protobuf.internal.WireSize.int32(it) + it
...
@kotlinx.rpc.internal.utils.InternalRpcApi
public fun com.google.protobuf.kotlin.EnumInternal.Companion.decodeWith(
    msg: com.google.protobuf.kotlin.EnumInternal,
    decoder: kotlinx.rpc.protobuf.internal.WireDecoder,
) {
    while (true) {
        val tag = decoder.readTag() ?: break // EOF, we read the whole message
...
public fun com.google.protobuf.kotlin.Enum.asInternal(): com.google.protobuf.kotlin.EnumInternal {
    return this as? com.google.protobuf.kotlin.EnumInternal
        ?: error("Message ${this::class.simpleName} is a non-internal message type.")
}
...
@kotlinx.rpc.internal.utils.InternalRpcApi
public fun com.google.protobuf.kotlin.EnumValueInternal.Companion.decodeWith(
    msg: com.google.protobuf.kotlin.EnumValueInternal,
    decoder: kotlinx.rpc.protobuf.internal.WireDecoder,
) {
    while (true) {
        val tag = decoder.readTag() ?: break // EOF, we read the whole message
...
public fun com.google.protobuf.kotlin.EnumValue.asInternal(): com.google.protobuf.kotlin.EnumValueInternal {
    return this as? com.google.protobuf.kotlin.EnumValueInternal
        ?: error("Message ${this::class.simpleName} is a non-internal message type.")
}
...
@kotlinx.rpc.internal.utils.InternalRpcApi
public fun com.google.protobuf.kotlin.OptionInternal.Companion.decodeWith(
    msg: com.google.protobuf.kotlin.OptionInternal,
    decoder: kotlinx.rpc.protobuf.internal.WireDecoder,
) {
    while (true) {
        val tag = decoder.readTag() ?: break // EOF, we read the whole message
...
public fun com.google.protobuf.kotlin.Option.asInternal(): com.google.protobuf.kotlin.OptionInternal {
    return this as? com.google.protobuf.kotlin.OptionInternal
        ?: error("Message ${this::class.simpleName} is a non-internal message type.")
}
