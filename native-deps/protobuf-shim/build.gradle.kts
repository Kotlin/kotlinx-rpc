...
// - :core publishes the protobuf shim KLIBs and native interop artifacts
...
version = "$protobufVersion-$shimVersion"
...
allprojects {
    ...
    plugins.withId("maven-publish") {
        extensions.configure<PublishingExtension> {
            repositories {
                // Fixture tests publish protobuf-shim artifacts here first and then consume them from isolated
