 ...
 *
 * This API exists only for the intended internal consumer of grpc-shim.
...
@RequiresOptIn(
    ...
    message = "grpc-shim native interop declarations are internal implementation details, unsupported for external use, and may change without compatibility guarantees.",
)
...
public annotation class InternalNativeRpcApi
