...
class ProtocolTest : ProtocolTestBase() {
    ...
    @Test
    fun testHandleUnknownPluginForClient() = runTest {
        val job = launch {
            service.sendRequest()
        }
        ...
        val serverHandshakeMessage = RPCTransportMessage.StringMessage(
            "{\"type\":\"org.jetbrains.krpc.internal.transport.RPCProtocolMessage.Handshake\",\"connectionId\":1,\"supportedPlugins\":[-32767, 32767]}" // 32767 is unknown to client
        )
    ...
    fun testUnknownPluginForServer() = runTest {
        ...
        val clientHandshakeMessage = RPCTransportMessage.StringMessage(
            "{\"type\":\"org.jetbrains.krpc.internal.transport.RPCProtocolMessage.Handshake\",\"connectionId\":1,\"supportedPlugins\":[-32767, 32767]}" // 32767 is unknown to server
        )
        ...
        assertEquals(RPCPlugin.ALL + RPCPlugin.UNKNOWN, defaultServer.clientPlugins[1])
    }
}
