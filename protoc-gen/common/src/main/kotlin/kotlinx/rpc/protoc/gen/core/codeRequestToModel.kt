...
private fun initNameTable(nameTable: FqNameTable) {
    nameTable.registerAll(
        ...
        FqName.Wkt.Duration,
        FqName.Wkt.Empty,
        FqName.Wkt.FieldMask,
        FqName.Wkt.SourceContext,
        FqName.Wkt.Struct,
        FqName.Wkt.Value,
        FqName.Wkt.ListValue,
        FqName.Wkt.NullValue,
        FqName.Wkt.Timestamp,
        FqName.Wkt.Type,
        FqName.Wkt.Field,
        FqName.Wkt.Enum,
        FqName.Wkt.EnumValue,
        FqName.Wkt.Option,
        FqName.Wkt.Syntax,
        FqName.Wkt.DoubleValue,
        FqName.Wkt.FloatValue,
        FqName.Wkt.Int64Value,
        FqName.Wkt.UInt64Value,
        FqName.Wkt.Int32Value,
        FqName.Wkt.UInt32Value,
        FqName.Wkt.BoolValue,
        FqName.Wkt.StringValue,
        FqName.Wkt.BytesValue,
        FqName.Wkt.FileDescriptorSet,
        FqName.Wkt.FileDescriptorProto,
        FqName.Wkt.DescriptorProto,
        FqName.Wkt.ExtensionRangeOptions,
        FqName.Wkt.FieldDescriptorProto,
        FqName.Wkt.OneofDescriptorProto,
        FqName.Wkt.EnumDescriptorProto,
        FqName.Wkt.EnumValueDescriptorProto,
        FqName.Wkt.ServiceDescriptorProto,
        FqName.Wkt.MethodDescriptorProto,
        FqName.Wkt.FileOptions,
        FqName.Wkt.MessageOptions,
        FqName.Wkt.FieldOptions,
        FqName.Wkt.OneofOptions,
        FqName.Wkt.EnumOptions,
        FqName.Wkt.EnumValueOptions,
        FqName.Wkt.ServiceOptions,
        FqName.Wkt.MethodOptions,
        FqName.Wkt.UninterpretedOption,
        FqName.Wkt.FeatureSet,
        FqName.Wkt.FeatureSetDefaults,
        FqName.Wkt.SourceCodeInfo,
        FqName.Wkt.GeneratedCodeInfo,
        FqName.Wkt.Edition,
        FqName.Wkt.SymbolVisibility,
    )
}
