...
internal class RpcStubGenerator(
    ...
    private fun IrClass.generateCallableMapProperty() {
        callableMap = generateMapProperty(
            propertyName = Descriptor.CALLABLE_MAP,
     ...
     *
     * ```kotlin
     *  final override val callables: Collection<RpcCallable<MyService>> get() = callableMap.values
     * ```
     */
        ...
        addProperty {
            ...
            addGetter {
                ...
                body = irBuilder(symbol).irBlockBody {
                    +irReturn(
                        irCallProperty(
                            receiver = irCallProperty(
                                clazz = this@generateCallablesProperty,
