...
includePublic(":krpc:krpc-transport")
includePublic(":krpc:krpc-transport:krpc-transport-ktor")
includePublic(":krpc:krpc-transport:krpc-transport-ktor:krpc-transport-ktor-server")
includePublic(":krpc:krpc-transport:krpc-transport-ktor:krpc-transport-ktor-client")
