...
import kotlinx.rpc.grpc.codec.WithMarshaller
import kotlinx.rpc.grpc.codec.MessageCodec
import kotlinx.io.Source

@WithMarshaller(TestCodec::class)
open class Test

@WithMarshaller(<!MARSHALLER_TYPE_MISMATCH!>TestCodec::class<!>)
class Test1
...
@WithMarshaller(<!NOT_AN_OBJECT_REFERENCE_IN_WITH_MARSHALLER_ANNOTATION!>TestCodec3::class<!>)
class Test3
...
@WithMarshaller(TestCodec4::class)
class Test4
...
@WithMarshaller(<!MARSHALLER_TYPE_MISMATCH!>TestCodec4::class<!>)
class Test5
...
@WithMarshaller(TestCodec8::class)
class Test8
...
@WithMarshaller(<!MARSHALLER_TYPE_MISMATCH!>TestCodec9::class<!>)
class Test9
