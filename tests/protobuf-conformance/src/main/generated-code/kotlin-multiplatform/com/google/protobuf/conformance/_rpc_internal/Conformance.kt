...
class TestStatusInternal : com.google.protobuf.conformance.TestStatus,
...
class FailureSetInternal : com.google.protobuf.conformance.FailureSet,
    kotlinx.rpc.protobuf.internal.InternalMessage(fieldsWithPresence = 0) {
    @kotlinx.rpc.internal.utils.InternalRpcApi
    override val _size: Int by lazy { computeSize() }
...
class ConformanceRequestInternal : com.google.protobuf.conformance.ConformanceRequest,
    ...
    override var jspbEncodingOptions: com.google.protobuf.conformance.JspbEncodingConfig by MsgFieldDelegate(
        PresenceIndices.jspbEncodingOptions
...
class ConformanceResponseInternal : com.google.protobuf.conformance.ConformanceResponse,
    kotlinx.rpc.protobuf.internal.InternalMessage(fieldsWithPresence = 0) {
    @kotlinx.rpc.internal.utils.InternalRpcApi
    override val _size: Int by lazy { computeSize() }
...
class JspbEncodingConfigInternal : com.google.protobuf.conformance.JspbEncodingConfig,
    kotlinx.rpc.protobuf.internal.InternalMessage(fieldsWithPresence = 0) {
    @kotlinx.rpc.internal.utils.InternalRpcApi
    override val _size: Int by lazy { computeSize() }
...
@kotlinx.rpc.internal.utils.InternalRpcApi
fun com.google.protobuf.conformance.TestStatusInternal.Companion.decodeWith(
...
private fun com.google.protobuf.conformance.TestStatusInternal.computeSize(): Int {
    var __result = 0
    if (name.isNotEmpty()) {
        __result += kotlinx.rpc.protobuf.internal.WireSize.string(name).let {
    ...
    if (failureMessage.isNotEmpty()) {
        __result += kotlinx.rpc.protobuf.internal.WireSize.string(failureMessage).let {
            kotlinx.rpc.protobuf.internal.WireSize.tag(
                2,
                kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED
            ) + kotlinx.rpc.protobuf.internal.WireSize.int32(it) + it
    ...
    if (matchedName.isNotEmpty()) {
        __result += kotlinx.rpc.protobuf.internal.WireSize.string(matchedName).let {
            kotlinx.rpc.protobuf.internal.WireSize.tag(
                3,
                kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED
            ) + kotlinx.rpc.protobuf.internal.WireSize.int32(it) + it
...
@kotlinx.rpc.internal.utils.InternalRpcApi
fun com.google.protobuf.conformance.FailureSetInternal.Companion.decodeWith(
    msg: com.google.protobuf.conformance.FailureSetInternal,
    decoder: kotlinx.rpc.protobuf.internal.WireDecoder,
) {
    while (true) {
        val tag = decoder.readTag() ?: break // EOF, we read the whole message
...
fun com.google.protobuf.conformance.FailureSet.asInternal(): com.google.protobuf.conformance.FailureSetInternal {
    return this as? com.google.protobuf.conformance.FailureSetInternal
        ?: error("Message ${this::class.simpleName} is a non-internal message type.")
}
...
@kotlinx.rpc.internal.utils.InternalRpcApi
fun com.google.protobuf.conformance.ConformanceRequestInternal.Companion.decodeWith(
    msg: com.google.protobuf.conformance.ConformanceRequestInternal,
    decoder: kotlinx.rpc.protobuf.internal.WireDecoder,
) {
    while (true) {
        val tag = decoder.readTag() ?: break // EOF, we read the whole message
        when {
            ...
            tag.fieldNr == 6 && tag.wireType == kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED -> {
                ...
                decoder.readMessage(
                    msg.jspbEncodingOptions.asInternal(),
                    com.google.protobuf.conformance.JspbEncodingConfigInternal::decodeWith
                )
            }
            ...
            tag.fieldNr == 1 && tag.wireType == kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED -> {
                msg.payload =
                    com.google.protobuf.conformance.ConformanceRequest.Payload.ProtobufPayload(decoder.readBytes())
            }

            tag.fieldNr == 2 && tag.wireType == kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED -> {
                msg.payload =
                    com.google.protobuf.conformance.ConformanceRequest.Payload.JsonPayload(decoder.readString())
            }

            tag.fieldNr == 7 && tag.wireType == kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED -> {
                msg.payload =
                    com.google.protobuf.conformance.ConformanceRequest.Payload.JspbPayload(decoder.readString())
            }

            tag.fieldNr == 8 && tag.wireType == kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED -> {
                msg.payload =
                    com.google.protobuf.conformance.ConformanceRequest.Payload.TextPayload(decoder.readString())
            }
...
private fun com.google.protobuf.conformance.ConformanceRequestInternal.computeSize(): Int {
    ...
    if (requestedOutputFormat != com.google.protobuf.conformance.WireFormat.UNSPECIFIED) {
        ...
        ) + kotlinx.rpc.protobuf.internal.WireSize.enum(requestedOutputFormat.number))
    }
    ...
    if (testCategory != com.google.protobuf.conformance.TestCategory.UNSPECIFIED_TEST) {
        __result += (kotlinx.rpc.protobuf.internal.WireSize.tag(
            5,
            kotlinx.rpc.protobuf.internal.WireType.VARINT
        ) + kotlinx.rpc.protobuf.internal.WireSize.enum(testCategory.number))
    }

    if (presenceMask[0]) {
        __result += jspbEncodingOptions.asInternal()._size.let {
            kotlinx.rpc.protobuf.internal.WireSize.tag(
                6,
                kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED
            ) + kotlinx.rpc.protobuf.internal.WireSize.int32(it) + it
    ...
    if (printUnknownFields != false) {
        __result += (kotlinx.rpc.protobuf.internal.WireSize.tag(
            9,
            kotlinx.rpc.protobuf.internal.WireType.VARINT
        ) + kotlinx.rpc.protobuf.internal.WireSize.bool(printUnknownFields))
    }
...
fun com.google.protobuf.conformance.ConformanceRequest.asInternal(): com.google.protobuf.conformance.ConformanceRequestInternal {
    return this as? com.google.protobuf.conformance.ConformanceRequestInternal
        ?: error("Message ${this::class.simpleName} is a non-internal message type.")
}
...
@kotlinx.rpc.internal.utils.InternalRpcApi
fun com.google.protobuf.conformance.ConformanceResponseInternal.Companion.decodeWith(
    msg: com.google.protobuf.conformance.ConformanceResponseInternal,
    decoder: kotlinx.rpc.protobuf.internal.WireDecoder,
) {
    while (true) {
        val tag = decoder.readTag() ?: break // EOF, we read the whole message
        when {
            ...
            tag.fieldNr == 6 && tag.wireType == kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED -> {
                msg.result =
                    com.google.protobuf.conformance.ConformanceResponse.Result.SerializeError(decoder.readString())
            }

            tag.fieldNr == 9 && tag.wireType == kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED -> {
                msg.result =
                    com.google.protobuf.conformance.ConformanceResponse.Result.TimeoutError(decoder.readString())
            }

            tag.fieldNr == 2 && tag.wireType == kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED -> {
                msg.result =
                    com.google.protobuf.conformance.ConformanceResponse.Result.RuntimeError(decoder.readString())
            }

            tag.fieldNr == 3 && tag.wireType == kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED -> {
                msg.result =
                    com.google.protobuf.conformance.ConformanceResponse.Result.ProtobufPayload(decoder.readBytes())
            }

            tag.fieldNr == 4 && tag.wireType == kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED -> {
                msg.result =
                    com.google.protobuf.conformance.ConformanceResponse.Result.JsonPayload(decoder.readString())
            }
            ...
            tag.fieldNr == 7 && tag.wireType == kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED -> {
                msg.result =
                    com.google.protobuf.conformance.ConformanceResponse.Result.JspbPayload(decoder.readString())
            }

            tag.fieldNr == 8 && tag.wireType == kotlinx.rpc.protobuf.internal.WireType.LENGTH_DELIMITED -> {
                msg.result =
                    com.google.protobuf.conformance.ConformanceResponse.Result.TextPayload(decoder.readString())
            }
...
fun com.google.protobuf.conformance.ConformanceResponse.asInternal(): com.google.protobuf.conformance.ConformanceResponseInternal {
    return this as? com.google.protobuf.conformance.ConformanceResponseInternal
        ?: error("Message ${this::class.simpleName} is a non-internal message type.")
}
...
@kotlinx.rpc.internal.utils.InternalRpcApi
fun com.google.protobuf.conformance.JspbEncodingConfigInternal.Companion.decodeWith(
...
private fun com.google.protobuf.conformance.JspbEncodingConfigInternal.computeSize(): Int {
    ...
    if (useJspbArrayAnyFormat != false) {
        __result += (kotlinx.rpc.protobuf.internal.WireSize.tag(
            1,
            kotlinx.rpc.protobuf.internal.WireType.VARINT
        ) + kotlinx.rpc.protobuf.internal.WireSize.bool(useJspbArrayAnyFormat))
    }
