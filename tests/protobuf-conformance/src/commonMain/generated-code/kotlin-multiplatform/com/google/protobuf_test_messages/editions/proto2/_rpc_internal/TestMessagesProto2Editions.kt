...
class TestAllTypesProto2Internal: TestAllTypesProto2.Builder, InternalMessage(fieldsWithPresence = 67) {
    ...
    internal val __optionalNestedEnumDelegate: MsgFieldDelegate<TestAllTypesProto2.NestedEnum> = MsgFieldDelegate(PresenceIndices.optionalNestedEnum) { TestAllTypesProto2.NestedEnum.FOO }
    ...
    internal val __optionalForeignEnumDelegate: MsgFieldDelegate<ForeignEnumProto2> = MsgFieldDelegate(PresenceIndices.optionalForeignEnum) { ForeignEnumProto2.FOREIGN_FOO }
    ...
    internal val __recursiveMessageDelegate: MsgFieldDelegate<TestAllTypesProto2> = MsgFieldDelegate(PresenceIndices.recursiveMessage) { DEFAULT }
    ...
    override fun clearData() {
        __dataDelegate.clearField(this)
    }
    ...
    override fun clearMultiwordgroupfield() {
        __multiwordgroupfieldDelegate.clearField(this)
    }
    ...
    override fun clearDefaultInt32() {
        __defaultInt32Delegate.clearField(this)
    }
    ...
    override fun clearDefaultInt64() {
        __defaultInt64Delegate.clearField(this)
    }
    ...
    override fun clearDefaultUint32() {
        __defaultUint32Delegate.clearField(this)
    }
    ...
    override fun clearDefaultUint64() {
        __defaultUint64Delegate.clearField(this)
    }
    ...
    override fun clearDefaultSint32() {
        __defaultSint32Delegate.clearField(this)
    }
    ...
    override fun clearDefaultSint64() {
        __defaultSint64Delegate.clearField(this)
    }
    ...
    override fun clearDefaultFixed32() {
        __defaultFixed32Delegate.clearField(this)
    }
    ...
    override fun clearDefaultFixed64() {
        __defaultFixed64Delegate.clearField(this)
    }
    ...
    override fun clearDefaultSfixed32() {
        __defaultSfixed32Delegate.clearField(this)
    }
    ...
    override fun clearDefaultSfixed64() {
        __defaultSfixed64Delegate.clearField(this)
    }

    internal val __defaultFloatDelegate: MsgFieldDelegate<Float> = MsgFieldDelegate(PresenceIndices.defaultFloat) { Float.fromBits(0x50061C46) }
    override var defaultFloat: Float by __defaultFloatDelegate
    override fun clearDefaultFloat() {
        __defaultFloatDelegate.clearField(this)
    }
    ...
    override fun clearDefaultDouble() {
        __defaultDoubleDelegate.clearField(this)
    }
    ...
    override fun clearDefaultBool() {
        __defaultBoolDelegate.clearField(this)
    }
    ...
    override fun clearDefaultString() {
        __defaultStringDelegate.clearField(this)
    }
    ...
    override fun clearDefaultBytes() {
        __defaultBytesDelegate.clearField(this)
    }

    internal val __fieldname1Delegate: MsgFieldDelegate<Int> = MsgFieldDelegate(PresenceIndices.fieldname1) { 0 }
    override var fieldname1: Int by __fieldname1Delegate
    override fun clearFieldname1() {
        __fieldname1Delegate.clearField(this)
    }

    internal val __fieldName2Delegate: MsgFieldDelegate<Int> = MsgFieldDelegate(PresenceIndices.fieldName2) { 0 }
    override var fieldName2: Int by __fieldName2Delegate
    override fun clearFieldName2() {
    ...
    override fun clearFieldName17__() {
    ...
    val _presence: TestAllTypesProto2Presence = object : TestAllTypesProto2Presence, InternalPresenceObject {
        ...
        override val hasOptionalInt32: Boolean get() = presenceMask[PresenceIndices.optionalInt32]

        override val hasOptionalInt64: Boolean get() = presenceMask[PresenceIndices.optionalInt64]

        override val hasOptionalUint32: Boolean get() = presenceMask[PresenceIndices.optionalUint32]

        override val hasOptionalUint64: Boolean get() = presenceMask[PresenceIndices.optionalUint64]

        override val hasOptionalSint32: Boolean get() = presenceMask[PresenceIndices.optionalSint32]

        override val hasOptionalSint64: Boolean get() = presenceMask[PresenceIndices.optionalSint64]

        override val hasOptionalFixed32: Boolean get() = presenceMask[PresenceIndices.optionalFixed32]

        override val hasOptionalFixed64: Boolean get() = presenceMask[PresenceIndices.optionalFixed64]

        override val hasOptionalSfixed32: Boolean get() = presenceMask[PresenceIndices.optionalSfixed32]

        override val hasOptionalSfixed64: Boolean get() = presenceMask[PresenceIndices.optionalSfixed64]

        override val hasOptionalFloat: Boolean get() = presenceMask[PresenceIndices.optionalFloat]

        override val hasOptionalDouble: Boolean get() = presenceMask[PresenceIndices.optionalDouble]

        override val hasOptionalBool: Boolean get() = presenceMask[PresenceIndices.optionalBool]

        override val hasOptionalString: Boolean get() = presenceMask[PresenceIndices.optionalString]

        override val hasOptionalBytes: Boolean get() = presenceMask[PresenceIndices.optionalBytes]
        ...
        override val hasOptionalNestedEnum: Boolean get() = presenceMask[PresenceIndices.optionalNestedEnum]

        override val hasOptionalForeignEnum: Boolean get() = presenceMask[PresenceIndices.optionalForeignEnum]

        override val hasOptionalStringPiece: Boolean get() = presenceMask[PresenceIndices.optionalStringPiece]
        ...
        override val hasDefaultInt32: Boolean get() = presenceMask[PresenceIndices.defaultInt32]

        override val hasDefaultInt64: Boolean get() = presenceMask[PresenceIndices.defaultInt64]

        override val hasDefaultUint32: Boolean get() = presenceMask[PresenceIndices.defaultUint32]

        override val hasDefaultUint64: Boolean get() = presenceMask[PresenceIndices.defaultUint64]

        override val hasDefaultSint32: Boolean get() = presenceMask[PresenceIndices.defaultSint32]

        override val hasDefaultSint64: Boolean get() = presenceMask[PresenceIndices.defaultSint64]

        override val hasDefaultFixed32: Boolean get() = presenceMask[PresenceIndices.defaultFixed32]

        override val hasDefaultFixed64: Boolean get() = presenceMask[PresenceIndices.defaultFixed64]

        override val hasDefaultSfixed32: Boolean get() = presenceMask[PresenceIndices.defaultSfixed32]

        override val hasDefaultSfixed64: Boolean get() = presenceMask[PresenceIndices.defaultSfixed64]

        override val hasDefaultFloat: Boolean get() = presenceMask[PresenceIndices.defaultFloat]

        override val hasDefaultDouble: Boolean get() = presenceMask[PresenceIndices.defaultDouble]

        override val hasDefaultBool: Boolean get() = presenceMask[PresenceIndices.defaultBool]

        override val hasDefaultString: Boolean get() = presenceMask[PresenceIndices.defaultString]

        override val hasDefaultBytes: Boolean get() = presenceMask[PresenceIndices.defaultBytes]

        override val hasFieldname1: Boolean get() = presenceMask[PresenceIndices.fieldname1]
    ...
    override fun hashCode(): Int {
        var result = if (presenceMask[PresenceIndices.optionalInt32]) this.optionalInt32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalInt64]) this.optionalInt64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalUint32]) this.optionalUint32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalUint64]) this.optionalUint64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalSint32]) this.optionalSint32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalSint64]) this.optionalSint64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalFixed32]) this.optionalFixed32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalFixed64]) this.optionalFixed64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalSfixed32]) this.optionalSfixed32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalSfixed64]) this.optionalSfixed64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalFloat]) this.optionalFloat.toBits().hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalDouble]) this.optionalDouble.toBits().hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalBool]) this.optionalBool.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalString]) this.optionalString.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalBytes]) this.optionalBytes.hashCode() else 0
        ...
        result = 31 * result + if (presenceMask[PresenceIndices.optionalNestedEnum]) this.optionalNestedEnum.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalForeignEnum]) this.optionalForeignEnum.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalStringPiece]) this.optionalStringPiece.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalCord]) this.optionalCord.hashCode() else 0
        ...
        result = 31 * result + if (presenceMask[PresenceIndices.defaultInt64]) this.defaultInt64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultUint32]) this.defaultUint32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultUint64]) this.defaultUint64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultSint32]) this.defaultSint32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultSint64]) this.defaultSint64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultFixed32]) this.defaultFixed32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultFixed64]) this.defaultFixed64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultSfixed32]) this.defaultSfixed32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultSfixed64]) this.defaultSfixed64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultFloat]) this.defaultFloat.toBits().hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultDouble]) this.defaultDouble.toBits().hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultBool]) this.defaultBool.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultString]) this.defaultString.hashCode() else 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (presenceMask[PresenceIndices.optionalInt32] && this.optionalInt32 != other.optionalInt32) return false
        if (presenceMask[PresenceIndices.optionalInt64] && this.optionalInt64 != other.optionalInt64) return false
        if (presenceMask[PresenceIndices.optionalUint32] && this.optionalUint32 != other.optionalUint32) return false
        if (presenceMask[PresenceIndices.optionalUint64] && this.optionalUint64 != other.optionalUint64) return false
        if (presenceMask[PresenceIndices.optionalSint32] && this.optionalSint32 != other.optionalSint32) return false
        if (presenceMask[PresenceIndices.optionalSint64] && this.optionalSint64 != other.optionalSint64) return false
        if (presenceMask[PresenceIndices.optionalFixed32] && this.optionalFixed32 != other.optionalFixed32) return false
        if (presenceMask[PresenceIndices.optionalFixed64] && this.optionalFixed64 != other.optionalFixed64) return false
        if (presenceMask[PresenceIndices.optionalSfixed32] && this.optionalSfixed32 != other.optionalSfixed32) return false
        if (presenceMask[PresenceIndices.optionalSfixed64] && this.optionalSfixed64 != other.optionalSfixed64) return false
        if (presenceMask[PresenceIndices.optionalFloat] && this.optionalFloat.toBits() != other.optionalFloat.toBits()) return false
        if (presenceMask[PresenceIndices.optionalDouble] && this.optionalDouble.toBits() != other.optionalDouble.toBits()) return false
        if (presenceMask[PresenceIndices.optionalBool] && this.optionalBool != other.optionalBool) return false
        if (presenceMask[PresenceIndices.optionalString] && this.optionalString != other.optionalString) return false
        if (presenceMask[PresenceIndices.optionalBytes] && this.optionalBytes != other.optionalBytes) return false
        ...
        if (presenceMask[PresenceIndices.optionalNestedEnum] && this.optionalNestedEnum != other.optionalNestedEnum) return false
        if (presenceMask[PresenceIndices.optionalForeignEnum] && this.optionalForeignEnum != other.optionalForeignEnum) return false
        if (presenceMask[PresenceIndices.optionalStringPiece] && this.optionalStringPiece != other.optionalStringPiece) return false
        if (presenceMask[PresenceIndices.optionalCord] && this.optionalCord != other.optionalCord) return false
        ...
        if (presenceMask[PresenceIndices.defaultInt64] && this.defaultInt64 != other.defaultInt64) return false
        if (presenceMask[PresenceIndices.defaultUint32] && this.defaultUint32 != other.defaultUint32) return false
        if (presenceMask[PresenceIndices.defaultUint64] && this.defaultUint64 != other.defaultUint64) return false
        if (presenceMask[PresenceIndices.defaultSint32] && this.defaultSint32 != other.defaultSint32) return false
        if (presenceMask[PresenceIndices.defaultSint64] && this.defaultSint64 != other.defaultSint64) return false
        if (presenceMask[PresenceIndices.defaultFixed32] && this.defaultFixed32 != other.defaultFixed32) return false
        if (presenceMask[PresenceIndices.defaultFixed64] && this.defaultFixed64 != other.defaultFixed64) return false
        if (presenceMask[PresenceIndices.defaultSfixed32] && this.defaultSfixed32 != other.defaultSfixed32) return false
        if (presenceMask[PresenceIndices.defaultSfixed64] && this.defaultSfixed64 != other.defaultSfixed64) return false
        if (presenceMask[PresenceIndices.defaultFloat] && this.defaultFloat.toBits() != other.defaultFloat.toBits()) return false
        if (presenceMask[PresenceIndices.defaultDouble] && this.defaultDouble.toBits() != other.defaultDouble.toBits()) return false
        if (presenceMask[PresenceIndices.defaultBool] && this.defaultBool != other.defaultBool) return false
        if (presenceMask[PresenceIndices.defaultString] && this.defaultString != other.defaultString) return false
    ...
    fun asString(indent: Int = 0): String {
        ...
        if (presenceMask[PresenceIndices.optionalInt64]) {
        ...
        if (presenceMask[PresenceIndices.optionalUint32]) {
        ...
        if (presenceMask[PresenceIndices.optionalUint64]) {
        ...
        if (presenceMask[PresenceIndices.optionalSint32]) {
        ...
        if (presenceMask[PresenceIndices.optionalSint64]) {
        ...
        if (presenceMask[PresenceIndices.optionalFixed32]) {
        ...
        if (presenceMask[PresenceIndices.optionalFixed64]) {
        ...
        if (presenceMask[PresenceIndices.optionalSfixed32]) {
        ...
        if (presenceMask[PresenceIndices.optionalSfixed64]) {
        ...
        if (presenceMask[PresenceIndices.optionalFloat]) {
        ...
        if (presenceMask[PresenceIndices.optionalDouble]) {
        ...
        if (presenceMask[PresenceIndices.optionalBytes]) {
        ...
        if (presenceMask[PresenceIndices.optionalNestedEnum]) {
        ...
        if (presenceMask[PresenceIndices.optionalForeignEnum]) {
        ...
        if (presenceMask[PresenceIndices.optionalStringPiece]) {
        ...
        if (presenceMask[PresenceIndices.optionalCord]) {
        ...
        if (presenceMask[PresenceIndices.multiwordgroupfield]) {
        ...
        if (presenceMask[PresenceIndices.defaultUint64]) {
        ...
        if (presenceMask[PresenceIndices.defaultSint32]) {
        ...
        if (presenceMask[PresenceIndices.defaultSint64]) {
        ...
        if (presenceMask[PresenceIndices.defaultFixed32]) {
        ...
        if (presenceMask[PresenceIndices.defaultFixed64]) {
        ...
        if (presenceMask[PresenceIndices.defaultSfixed32]) {
        ...
        if (presenceMask[PresenceIndices.defaultSfixed64]) {
        ...
        if (presenceMask[PresenceIndices.defaultBytes]) {
    ...
    class NestedMessageInternal: TestAllTypesProto2.NestedMessage.Builder, InternalMessage(fieldsWithPresence = 2) {
        ...
        override fun hashCode(): Int {
            var result = if (presenceMask[PresenceIndices.a]) this.a.hashCode() else 0
    ...
    class MapInt32FloatEntryInternal: InternalMessage(fieldsWithPresence = 2) {
        ...
        override fun hashCode(): Int {
            var result = if (presenceMask[PresenceIndices.key]) this.key.hashCode() else 0
            result = 31 * result + if (presenceMask[PresenceIndices.value]) this.value.toBits().hashCode() else 0
            return result
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            if (presenceMask != other.presenceMask) return false
            if (presenceMask[PresenceIndices.key] && this.key != other.key) return false
            return !presenceMask[PresenceIndices.value] || this.value.toBits() == other.value.toBits()
        }
    ...
    class DataInternal: TestAllTypesProto2.Data.Builder, InternalMessage(fieldsWithPresence = 2) {
        ...
        object DESCRIPTOR: ProtoDescriptor<TestAllTypesProto2.Data> {
            override val fullName: String = "protobuf_test_messages.editions.proto2.TestAllTypesProto2.Data"
        }
    ...
    class MultiWordGroupFieldInternal: TestAllTypesProto2.MultiWordGroupField.Builder, InternalMessage(fieldsWithPresence = 2) {
        ...
        object DESCRIPTOR: ProtoDescriptor<TestAllTypesProto2.MultiWordGroupField> {
            override val fullName: String = "protobuf_test_messages.editions.proto2.TestAllTypesProto2.MultiWordGroupField"
        }
    ...
    class MessageSetCorrectExtension1Internal: TestAllTypesProto2.MessageSetCorrectExtension1.Builder, InternalMessage(fieldsWithPresence = 1) {
        ...
        override fun clearStr() {
            __strDelegate.clearField(this)
        }
        ...
        val _presence: TestAllTypesProto2Presence.MessageSetCorrectExtension1 = object : TestAllTypesProto2Presence.MessageSetCorrectExtension1, InternalPresenceObject {
            ...
            override val hasStr: Boolean get() = presenceMask[PresenceIndices.str]
        }

        override fun hashCode(): Int {
            var result = if (presenceMask[PresenceIndices.str]) this.str.hashCode() else 0
            return result
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            if (presenceMask != other.presenceMask) return false
            return !presenceMask[PresenceIndices.str] || this.str == other.str
        }
    ...
    class ExtensionWithOneofInternal: TestAllTypesProto2.ExtensionWithOneof.Builder, InternalMessage(fieldsWithPresence = 2) {
        ...
        override fun clearA() {
            if (presenceMask[PresenceIndices.a]) clearOneofFieldInternal()
        }
        ...
        override fun clearB() {
            if (presenceMask[PresenceIndices.b]) clearOneofFieldInternal()
        }
...
class ForeignMessageProto2Internal: ForeignMessageProto2.Builder, InternalMessage(fieldsWithPresence = 1) {
    ...
    val _presence: ForeignMessageProto2Presence = object : ForeignMessageProto2Presence, InternalPresenceObject {
        ...
        override val hasC: Boolean get() = presenceMask[PresenceIndices.c]
    }

    override fun hashCode(): Int {
        var result = if (presenceMask[PresenceIndices.c]) this.c.hashCode() else 0
        return result
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (presenceMask != other.presenceMask) return false
        return !presenceMask[PresenceIndices.c] || this.c == other.c
    }
...
class UnknownToTestAllTypesInternal: UnknownToTestAllTypes.Builder, InternalMessage(fieldsWithPresence = 5) {
    ...
    override fun clearNestedMessage() {
        __nestedMessageDelegate.clearField(this)
    }
    ...
    override fun clearOptionalgroup() {
        __optionalgroupDelegate.clearField(this)
    }
    ...
    val _presence: UnknownToTestAllTypesPresence = object : UnknownToTestAllTypesPresence, InternalPresenceObject {
        ...
        override val hasNestedMessage: Boolean get() = presenceMask[PresenceIndices.nestedMessage]

        override val hasOptionalgroup: Boolean get() = presenceMask[PresenceIndices.optionalgroup]
    ...
    override fun hashCode(): Int {
        var result = if (presenceMask[PresenceIndices.optionalInt32]) this.optionalInt32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalString]) this.optionalString.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.nestedMessage]) this.nestedMessage.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalgroup]) this.optionalgroup.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalBool]) this.optionalBool.hashCode() else 0
        result = 31 * result + this.repeatedInt32.hashCode()
        return result
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (presenceMask[PresenceIndices.optionalInt32] && this.optionalInt32 != other.optionalInt32) return false
        if (presenceMask[PresenceIndices.optionalString] && this.optionalString != other.optionalString) return false
        if (presenceMask[PresenceIndices.nestedMessage] && this.nestedMessage != other.nestedMessage) return false
        if (presenceMask[PresenceIndices.optionalgroup] && this.optionalgroup != other.optionalgroup) return false
        if (presenceMask[PresenceIndices.optionalBool] && this.optionalBool != other.optionalBool) return false
        return this.repeatedInt32 == other.repeatedInt32
    }
    ...
    fun asString(indent: Int = 0): String {
        ...
        if (presenceMask[PresenceIndices.nestedMessage]) {
        ...
        if (presenceMask[PresenceIndices.optionalgroup]) {
    ...
    class OptionalGroupInternal: UnknownToTestAllTypes.OptionalGroup.Builder, InternalMessage(fieldsWithPresence = 1) {
        ...
        override fun equals(other: Any?): Boolean {
            ...
            if (presenceMask != other.presenceMask) return false
            return !presenceMask[PresenceIndices.a] || this.a == other.a
        }
        ...
        object DESCRIPTOR: ProtoDescriptor<UnknownToTestAllTypes.OptionalGroup> {
            override val fullName: String = "protobuf_test_messages.editions.proto2.UnknownToTestAllTypes.OptionalGroup"
        }
...
class OneStringProto2Internal: OneStringProto2.Builder, InternalMessage(fieldsWithPresence = 1) {
    ...
    internal val __dataDelegate: MsgFieldDelegate<String> = MsgFieldDelegate(PresenceIndices.data) { "" }
    ...
    override fun hashCode(): Int {
        var result = if (presenceMask[PresenceIndices.data]) this.data.hashCode() else 0
        return result
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (presenceMask != other.presenceMask) return false
        return !presenceMask[PresenceIndices.data] || this.data == other.data
    }
...
class ProtoWithKeywordsInternal: ProtoWithKeywords.Builder, InternalMessage(fieldsWithPresence = 2) {
    ...
    internal val __inlineDelegate: MsgFieldDelegate<Int> = MsgFieldDelegate(PresenceIndices.inline) { 0 }
    override var inline: Int by __inlineDelegate
    override fun clearInline() {
        __inlineDelegate.clearField(this)
    }

    internal val __conceptDelegate: MsgFieldDelegate<String> = MsgFieldDelegate(PresenceIndices.concept) { "" }
    override var concept: String by __conceptDelegate
    override fun clearConcept() {
        __conceptDelegate.clearField(this)
    }
    ...
    val _presence: ProtoWithKeywordsPresence = object : ProtoWithKeywordsPresence, InternalPresenceObject {
        ...
        override val hasInline: Boolean get() = presenceMask[PresenceIndices.inline]

        override val hasConcept: Boolean get() = presenceMask[PresenceIndices.concept]
    }

    override fun hashCode(): Int {
        var result = if (presenceMask[PresenceIndices.inline]) this.inline.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.concept]) this.concept.hashCode() else 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (presenceMask != other.presenceMask) return false
        if (presenceMask[PresenceIndices.inline] && this.inline != other.inline) return false
        if (presenceMask[PresenceIndices.concept] && this.concept != other.concept) return false
        return this.requires == other.requires
    }
...
class TestAllRequiredTypesProto2Internal: TestAllRequiredTypesProto2.Builder, InternalMessage(fieldsWithPresence = 39) {
    ...
    override fun clearRequiredInt32() {
        __requiredInt32Delegate.clearField(this)
    }
    ...
    override fun clearRequiredInt64() {
        __requiredInt64Delegate.clearField(this)
    }
    ...
    override fun clearRequiredUint32() {
        __requiredUint32Delegate.clearField(this)
    }
    ...
    override fun clearRequiredUint64() {
        __requiredUint64Delegate.clearField(this)
    }
    ...
    override fun clearRequiredSint32() {
        __requiredSint32Delegate.clearField(this)
    }
    ...
    override fun clearRequiredSint64() {
        __requiredSint64Delegate.clearField(this)
    }
    ...
    override fun clearRequiredFixed32() {
        __requiredFixed32Delegate.clearField(this)
    }
    ...
    override fun clearRequiredFixed64() {
        __requiredFixed64Delegate.clearField(this)
    }
    ...
    override fun clearRequiredSfixed32() {
        __requiredSfixed32Delegate.clearField(this)
    }
    ...
    override fun clearRequiredSfixed64() {
        __requiredSfixed64Delegate.clearField(this)
    }
    ...
    override fun clearRequiredFloat() {
        __requiredFloatDelegate.clearField(this)
    }
    ...
    override fun clearRequiredDouble() {
        __requiredDoubleDelegate.clearField(this)
    }
    ...
    override fun clearRequiredBool() {
        __requiredBoolDelegate.clearField(this)
    }
    ...
    override fun clearRequiredString() {
        __requiredStringDelegate.clearField(this)
    }
    ...
    override fun clearRequiredBytes() {
        __requiredBytesDelegate.clearField(this)
    }
    ...
    override fun clearRequiredNestedMessage() {
        __requiredNestedMessageDelegate.clearField(this)
    }
    ...
    override fun clearRequiredForeignMessage() {
        __requiredForeignMessageDelegate.clearField(this)
    }
    ...
    override fun clearRequiredNestedEnum() {
        __requiredNestedEnumDelegate.clearField(this)
    }
    ...
    override fun clearRequiredForeignEnum() {
        __requiredForeignEnumDelegate.clearField(this)
    }
    ...
    override fun clearRequiredStringPiece() {
        __requiredStringPieceDelegate.clearField(this)
    }
    ...
    override fun clearRequiredCord() {
        __requiredCordDelegate.clearField(this)
    }

    internal val __recursiveMessageDelegate: MsgFieldDelegate<TestAllRequiredTypesProto2> = MsgFieldDelegate(PresenceIndices.recursiveMessage) { DEFAULT }
    override var recursiveMessage: TestAllRequiredTypesProto2 by __recursiveMessageDelegate
    override fun clearRecursiveMessage() {
        __recursiveMessageDelegate.clearField(this)
    }

    internal val __optionalRecursiveMessageDelegate: MsgFieldDelegate<TestAllRequiredTypesProto2> = MsgFieldDelegate(PresenceIndices.optionalRecursiveMessage) { DEFAULT }
    override var optionalRecursiveMessage: TestAllRequiredTypesProto2 by __optionalRecursiveMessageDelegate
    override fun clearOptionalRecursiveMessage() {
        __optionalRecursiveMessageDelegate.clearField(this)
    }
    ...
    val _presence: TestAllRequiredTypesProto2Presence = object : TestAllRequiredTypesProto2Presence, InternalPresenceObject {
        ...
        override val hasRequiredInt32: Boolean get() = presenceMask[PresenceIndices.requiredInt32]

        override val hasRequiredInt64: Boolean get() = presenceMask[PresenceIndices.requiredInt64]

        override val hasRequiredUint32: Boolean get() = presenceMask[PresenceIndices.requiredUint32]

        override val hasRequiredUint64: Boolean get() = presenceMask[PresenceIndices.requiredUint64]

        override val hasRequiredSint32: Boolean get() = presenceMask[PresenceIndices.requiredSint32]

        override val hasRequiredSint64: Boolean get() = presenceMask[PresenceIndices.requiredSint64]

        override val hasRequiredFixed32: Boolean get() = presenceMask[PresenceIndices.requiredFixed32]

        override val hasRequiredFixed64: Boolean get() = presenceMask[PresenceIndices.requiredFixed64]

        override val hasRequiredSfixed32: Boolean get() = presenceMask[PresenceIndices.requiredSfixed32]

        override val hasRequiredSfixed64: Boolean get() = presenceMask[PresenceIndices.requiredSfixed64]

        override val hasRequiredFloat: Boolean get() = presenceMask[PresenceIndices.requiredFloat]

        override val hasRequiredDouble: Boolean get() = presenceMask[PresenceIndices.requiredDouble]

        override val hasRequiredBool: Boolean get() = presenceMask[PresenceIndices.requiredBool]

        override val hasRequiredString: Boolean get() = presenceMask[PresenceIndices.requiredString]

        override val hasRequiredBytes: Boolean get() = presenceMask[PresenceIndices.requiredBytes]

        override val hasRequiredNestedMessage: Boolean get() = presenceMask[PresenceIndices.requiredNestedMessage]

        override val hasRequiredForeignMessage: Boolean get() = presenceMask[PresenceIndices.requiredForeignMessage]

        override val hasRequiredNestedEnum: Boolean get() = presenceMask[PresenceIndices.requiredNestedEnum]

        override val hasRequiredForeignEnum: Boolean get() = presenceMask[PresenceIndices.requiredForeignEnum]

        override val hasRequiredStringPiece: Boolean get() = presenceMask[PresenceIndices.requiredStringPiece]

        override val hasRequiredCord: Boolean get() = presenceMask[PresenceIndices.requiredCord]

        override val hasRecursiveMessage: Boolean get() = presenceMask[PresenceIndices.recursiveMessage]

        override val hasOptionalRecursiveMessage: Boolean get() = presenceMask[PresenceIndices.optionalRecursiveMessage]
    ...
    override fun hashCode(): Int {
        checkRequiredFields()
        var result = if (presenceMask[PresenceIndices.requiredInt32]) this.requiredInt32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredInt64]) this.requiredInt64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredUint32]) this.requiredUint32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredUint64]) this.requiredUint64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredSint32]) this.requiredSint32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredSint64]) this.requiredSint64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredFixed32]) this.requiredFixed32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredFixed64]) this.requiredFixed64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredSfixed32]) this.requiredSfixed32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredSfixed64]) this.requiredSfixed64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredFloat]) this.requiredFloat.toBits().hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredDouble]) this.requiredDouble.toBits().hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredBool]) this.requiredBool.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredString]) this.requiredString.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredBytes]) this.requiredBytes.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredNestedMessage]) this.requiredNestedMessage.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredForeignMessage]) this.requiredForeignMessage.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredNestedEnum]) this.requiredNestedEnum.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredForeignEnum]) this.requiredForeignEnum.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredStringPiece]) this.requiredStringPiece.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.requiredCord]) this.requiredCord.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.recursiveMessage]) this.recursiveMessage.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.optionalRecursiveMessage]) this.optionalRecursiveMessage.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.data]) this.data.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultInt32]) this.defaultInt32.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultInt64]) this.defaultInt64.hashCode() else 0
        result = 31 * result + if (presenceMask[PresenceIndices.defaultUint32]) this.defaultUint32.hashCode() else 0
    ...
    override fun equals(other: Any?): Boolean {
        ...
        if (presenceMask != other.presenceMask) return false
        if (presenceMask[PresenceIndices.requiredInt32] && this.requiredInt32 != other.requiredInt32) return false
        if (presenceMask[PresenceIndices.requiredInt64] && this.requiredInt64 != other.requiredInt64) return false
        if (presenceMask[PresenceIndices.requiredUint32] && this.requiredUint32 != other.requiredUint32) return false
        if (presenceMask[PresenceIndices.requiredUint64] && this.requiredUint64 != other.requiredUint64) return false
        if (presenceMask[PresenceIndices.requiredSint32] && this.requiredSint32 != other.requiredSint32) return false
        if (presenceMask[PresenceIndices.requiredSint64] && this.requiredSint64 != other.requiredSint64) return false
        if (presenceMask[PresenceIndices.requiredFixed32] && this.requiredFixed32 != other.requiredFixed32) return false
        if (presenceMask[PresenceIndices.requiredFixed64] && this.requiredFixed64 != other.requiredFixed64) return false
        if (presenceMask[PresenceIndices.requiredSfixed32] && this.requiredSfixed32 != other.requiredSfixed32) return false
        if (presenceMask[PresenceIndices.requiredSfixed64] && this.requiredSfixed64 != other.requiredSfixed64) return false
        if (presenceMask[PresenceIndices.requiredFloat] && this.requiredFloat.toBits() != other.requiredFloat.toBits()) return false
        if (presenceMask[PresenceIndices.requiredDouble] && this.requiredDouble.toBits() != other.requiredDouble.toBits()) return false
        if (presenceMask[PresenceIndices.requiredBool] && this.requiredBool != other.requiredBool) return false
        if (presenceMask[PresenceIndices.requiredString] && this.requiredString != other.requiredString) return false
        if (presenceMask[PresenceIndices.requiredBytes] && this.requiredBytes != other.requiredBytes) return false
        if (presenceMask[PresenceIndices.requiredNestedMessage] && this.requiredNestedMessage != other.requiredNestedMessage) return false
        if (presenceMask[PresenceIndices.requiredForeignMessage] && this.requiredForeignMessage != other.requiredForeignMessage) return false
        if (presenceMask[PresenceIndices.requiredNestedEnum] && this.requiredNestedEnum != other.requiredNestedEnum) return false
        if (presenceMask[PresenceIndices.requiredForeignEnum] && this.requiredForeignEnum != other.requiredForeignEnum) return false
        if (presenceMask[PresenceIndices.requiredStringPiece] && this.requiredStringPiece != other.requiredStringPiece) return false
        if (presenceMask[PresenceIndices.requiredCord] && this.requiredCord != other.requiredCord) return false
        if (presenceMask[PresenceIndices.recursiveMessage] && this.recursiveMessage != other.recursiveMessage) return false
        if (presenceMask[PresenceIndices.optionalRecursiveMessage] && this.optionalRecursiveMessage != other.optionalRecursiveMessage) return false
        if (presenceMask[PresenceIndices.data] && this.data != other.data) return false
        if (presenceMask[PresenceIndices.defaultInt32] && this.defaultInt32 != other.defaultInt32) return false
        if (presenceMask[PresenceIndices.defaultInt64] && this.defaultInt64 != other.defaultInt64) return false
        if (presenceMask[PresenceIndices.defaultUint32] && this.defaultUint32 != other.defaultUint32) return false
    ...
    fun asString(indent: Int = 0): String {
        ...
        if (presenceMask[PresenceIndices.requiredInt64]) {
        ...
        if (presenceMask[PresenceIndices.requiredUint32]) {
        ...
        if (presenceMask[PresenceIndices.requiredUint64]) {
        ...
        if (presenceMask[PresenceIndices.requiredSint32]) {
        ...
        if (presenceMask[PresenceIndices.requiredSint64]) {
        ...
        if (presenceMask[PresenceIndices.requiredFixed32]) {
        ...
        if (presenceMask[PresenceIndices.requiredFixed64]) {
        ...
        if (presenceMask[PresenceIndices.requiredSfixed32]) {
        ...
        if (presenceMask[PresenceIndices.requiredSfixed64]) {
        ...
        if (presenceMask[PresenceIndices.requiredFloat]) {
        ...
        if (presenceMask[PresenceIndices.requiredDouble]) {
        ...
        if (presenceMask[PresenceIndices.requiredBytes]) {
        ...
        if (presenceMask[PresenceIndices.requiredNestedMessage]) {
        ...
        if (presenceMask[PresenceIndices.requiredForeignMessage]) {
        ...
        if (presenceMask[PresenceIndices.requiredNestedEnum]) {
        ...
        if (presenceMask[PresenceIndices.requiredForeignEnum]) {
        ...
        if (presenceMask[PresenceIndices.requiredStringPiece]) {
        ...
        if (presenceMask[PresenceIndices.requiredCord]) {
        ...
        if (presenceMask[PresenceIndices.optionalRecursiveMessage]) {
    ...
    class NestedMessageInternal: TestAllRequiredTypesProto2.NestedMessage.Builder, InternalMessage(fieldsWithPresence = 3) {
        ...
        override fun clearOptionalCorecursive() {
            __optionalCorecursiveDelegate.clearField(this)
        }
        ...
        val _presence: TestAllRequiredTypesProto2Presence.NestedMessage = object : TestAllRequiredTypesProto2Presence.NestedMessage, InternalPresenceObject {
            ...
            override val hasOptionalCorecursive: Boolean get() = presenceMask[PresenceIndices.optionalCorecursive]
        }
        ...
        override fun hashCode(): Int {
            ...
            var result = if (presenceMask[PresenceIndices.a]) this.a.hashCode() else 0
            result = 31 * result + if (presenceMask[PresenceIndices.corecursive]) this.corecursive.hashCode() else 0
            result = 31 * result + if (presenceMask[PresenceIndices.optionalCorecursive]) this.optionalCorecursive.hashCode() else 0
            return result
        }
        ...
        override fun equals(other: Any?): Boolean {
            ...
            if (presenceMask != other.presenceMask) return false
            if (presenceMask[PresenceIndices.a] && this.a != other.a) return false
            if (presenceMask[PresenceIndices.corecursive] && this.corecursive != other.corecursive) return false
            return !presenceMask[PresenceIndices.optionalCorecursive] || this.optionalCorecursive == other.optionalCorecursive
        }
        ...
        fun asString(indent: Int = 0): String {
            ...
            if (presenceMask[PresenceIndices.optionalCorecursive]) {
    ...
    class DataInternal: TestAllRequiredTypesProto2.Data.Builder, InternalMessage(fieldsWithPresence = 2) {
        ...
        object DESCRIPTOR: ProtoDescriptor<TestAllRequiredTypesProto2.Data> {
            override val fullName: String = "protobuf_test_messages.editions.proto2.TestAllRequiredTypesProto2.Data"
        }
...
class TestLargeOneofInternal: TestLargeOneof.Builder, InternalMessage(fieldsWithPresence = 5) {
    ...
    override fun clearA1() {
        if (presenceMask[PresenceIndices.a1]) clearLargeOneofInternal()
    }
    ...
    override fun clearA2() {
        if (presenceMask[PresenceIndices.a2]) clearLargeOneofInternal()
    }
    ...
    override fun clearA3() {
        if (presenceMask[PresenceIndices.a3]) clearLargeOneofInternal()
    }
    ...
    override fun clearA4() {
        if (presenceMask[PresenceIndices.a4]) clearLargeOneofInternal()
    }
    ...
    override fun clearA5() {
        if (presenceMask[PresenceIndices.a5]) clearLargeOneofInternal()
    }
...
fun TestAllTypesProto2Internal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalInt32]) {
        encoder.writeInt32(fieldNr = 1, value = this.optionalInt32)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalInt64]) {
        encoder.writeInt64(fieldNr = 2, value = this.optionalInt64)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalUint32]) {
        encoder.writeUInt32(fieldNr = 3, value = this.optionalUint32)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalUint64]) {
        encoder.writeUInt64(fieldNr = 4, value = this.optionalUint64)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalSint32]) {
        encoder.writeSInt32(fieldNr = 5, value = this.optionalSint32)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalSint64]) {
        encoder.writeSInt64(fieldNr = 6, value = this.optionalSint64)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalFixed32]) {
        encoder.writeFixed32(fieldNr = 7, value = this.optionalFixed32)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalFixed64]) {
        encoder.writeFixed64(fieldNr = 8, value = this.optionalFixed64)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalSfixed32]) {
        encoder.writeSFixed32(fieldNr = 9, value = this.optionalSfixed32)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalSfixed64]) {
        encoder.writeSFixed64(fieldNr = 10, value = this.optionalSfixed64)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalFloat]) {
        encoder.writeFloat(fieldNr = 11, value = this.optionalFloat)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalDouble]) {
        encoder.writeDouble(fieldNr = 12, value = this.optionalDouble)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalBool]) {
        encoder.writeBool(fieldNr = 13, value = this.optionalBool)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalString]) {
        encoder.writeString(fieldNr = 14, value = this.optionalString)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalBytes]) {
        encoder.writeBytes(fieldNr = 15, value = this.optionalBytes)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalNestedMessage]) {
        encoder.writeMessage(fieldNr = 18, value = this.optionalNestedMessage.asInternal()) { encoder -> encodeWith(encoder, config) }
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalForeignMessage]) {
        encoder.writeMessage(fieldNr = 19, value = this.optionalForeignMessage.asInternal()) { encoder -> encodeWith(encoder, config) }
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalNestedEnum]) {
        encoder.writeEnum(fieldNr = 21, value = this.optionalNestedEnum.number)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalForeignEnum]) {
        encoder.writeEnum(fieldNr = 22, value = this.optionalForeignEnum.number)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalStringPiece]) {
        encoder.writeString(fieldNr = 24, value = this.optionalStringPiece)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.optionalCord]) {
        encoder.writeString(fieldNr = 25, value = this.optionalCord)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.recursiveMessage]) {
    ...
    if (this.mapInt32Bool.isNotEmpty()) {
        this.mapInt32Bool.forEach { kEntry ->
            ...
            .also { entry ->
                encoder.writeMessage(fieldNr = 104, value = entry.asInternal()) { encoder -> encodeWith(encoder, config) }
            }
        }
    }
    ...
    if (this.mapInt32NestedMessage.isNotEmpty()) {
        this.mapInt32NestedMessage.forEach { kEntry ->
            ...
            .also { entry ->
                encoder.writeMessage(fieldNr = 103, value = entry.asInternal()) { encoder -> encodeWith(encoder, config) }
            }
        }
    }
    ...
    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.multiwordgroupfield]) {
        encoder.writeGroupMessage(fieldNr = 204, value = this.multiwordgroupfield.asInternal()) { encoder -> encodeWith(encoder, config) }
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultInt32]) {
        encoder.writeInt32(fieldNr = 241, value = this.defaultInt32)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultInt64]) {
        encoder.writeInt64(fieldNr = 242, value = this.defaultInt64)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultUint32]) {
        encoder.writeUInt32(fieldNr = 243, value = this.defaultUint32)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultUint64]) {
        encoder.writeUInt64(fieldNr = 244, value = this.defaultUint64)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultSint32]) {
        encoder.writeSInt32(fieldNr = 245, value = this.defaultSint32)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultSint64]) {
        encoder.writeSInt64(fieldNr = 246, value = this.defaultSint64)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultFixed32]) {
        encoder.writeFixed32(fieldNr = 247, value = this.defaultFixed32)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultFixed64]) {
        encoder.writeFixed64(fieldNr = 248, value = this.defaultFixed64)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultSfixed32]) {
        encoder.writeSFixed32(fieldNr = 249, value = this.defaultSfixed32)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultSfixed64]) {
        encoder.writeSFixed64(fieldNr = 250, value = this.defaultSfixed64)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultFloat]) {
        encoder.writeFloat(fieldNr = 251, value = this.defaultFloat)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultDouble]) {
        encoder.writeDouble(fieldNr = 252, value = this.defaultDouble)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultBool]) {
        encoder.writeBool(fieldNr = 253, value = this.defaultBool)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultString]) {
        encoder.writeString(fieldNr = 254, value = this.defaultString)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.defaultBytes]) {
        encoder.writeBytes(fieldNr = 255, value = this.defaultBytes)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.fieldname1]) {
        encoder.writeInt32(fieldNr = 401, value = this.fieldname1)
    }

    if (presenceMask[TestAllTypesProto2Internal.PresenceIndices.fieldName2]) {
...
fun TestAllTypesProto2Internal.Companion.decodeWith(msg: TestAllTypesProto2Internal, decoder: WireDecoder, config: ProtoConfig?) {
    ...
    while (true) {
        ...
        when (tag.fieldNr) {
            ...
            104 if tag.wireType == WireType.LENGTH_DELIMITED -> {
            ...
            103 if tag.wireType == WireType.LENGTH_DELIMITED -> {
            ...
            204 if tag.wireType == WireType.START_GROUP -> {
            ...
            241 if tag.wireType == WireType.VARINT -> {
                msg.defaultInt32 = decoder.readInt32()
            }
            242 if tag.wireType == WireType.VARINT -> {
                msg.defaultInt64 = decoder.readInt64()
            }
            243 if tag.wireType == WireType.VARINT -> {
                msg.defaultUint32 = decoder.readUInt32()
            }
            244 if tag.wireType == WireType.VARINT -> {
                msg.defaultUint64 = decoder.readUInt64()
            }
            245 if tag.wireType == WireType.VARINT -> {
                msg.defaultSint32 = decoder.readSInt32()
            }
            246 if tag.wireType == WireType.VARINT -> {
                msg.defaultSint64 = decoder.readSInt64()
            }
            247 if tag.wireType == WireType.FIXED32 -> {
                msg.defaultFixed32 = decoder.readFixed32()
            }
            248 if tag.wireType == WireType.FIXED64 -> {
                msg.defaultFixed64 = decoder.readFixed64()
            }
            249 if tag.wireType == WireType.FIXED32 -> {
                msg.defaultSfixed32 = decoder.readSFixed32()
            }
            250 if tag.wireType == WireType.FIXED64 -> {
                msg.defaultSfixed64 = decoder.readSFixed64()
            }
            251 if tag.wireType == WireType.FIXED32 -> {
                msg.defaultFloat = decoder.readFloat()
            }
            252 if tag.wireType == WireType.FIXED64 -> {
                msg.defaultDouble = decoder.readDouble()
            }
            253 if tag.wireType == WireType.VARINT -> {
                msg.defaultBool = decoder.readBool()
            }
            254 if tag.wireType == WireType.LENGTH_DELIMITED -> {
                msg.defaultString = decoder.readString()
            }
            255 if tag.wireType == WireType.LENGTH_DELIMITED -> {
...
private fun TestAllTypesProto2Internal.computeSize(): Int {
    ...
    if (this.repeatedInt32.isNotEmpty()) {
        __result += this.repeatedInt32.sumOf { element -> WireSize.tag(31, WireType.VARINT) + WireSize.int32(element) }
    }

    if (this.repeatedInt64.isNotEmpty()) {
        __result += this.repeatedInt64.sumOf { element -> WireSize.tag(32, WireType.VARINT) + WireSize.int64(element) }
    }

    if (this.repeatedUint32.isNotEmpty()) {
        __result += this.repeatedUint32.sumOf { element -> WireSize.tag(33, WireType.VARINT) + WireSize.uInt32(element) }
    }

    if (this.repeatedUint64.isNotEmpty()) {
        __result += this.repeatedUint64.sumOf { element -> WireSize.tag(34, WireType.VARINT) + WireSize.uInt64(element) }
    }

    if (this.repeatedSint32.isNotEmpty()) {
        __result += this.repeatedSint32.sumOf { element -> WireSize.tag(35, WireType.VARINT) + WireSize.sInt32(element) }
    }

    if (this.repeatedSint64.isNotEmpty()) {
        __result += this.repeatedSint64.sumOf { element -> WireSize.tag(36, WireType.VARINT) + WireSize.sInt64(element) }
    }

    if (this.repeatedFixed32.isNotEmpty()) {
        __result += this.repeatedFixed32.sumOf { element -> WireSize.tag(37, WireType.FIXED32) + WireSize.fixed32(element) }
    }

    if (this.repeatedFixed64.isNotEmpty()) {
        __result += this.repeatedFixed64.sumOf { element -> WireSize.tag(38, WireType.FIXED64) + WireSize.fixed64(element) }
    }

    if (this.repeatedSfixed32.isNotEmpty()) {
        __result += this.repeatedSfixed32.sumOf { element -> WireSize.tag(39, WireType.FIXED32) + WireSize.sFixed32(element) }
    }

    if (this.repeatedSfixed64.isNotEmpty()) {
        __result += this.repeatedSfixed64.sumOf { element -> WireSize.tag(40, WireType.FIXED64) + WireSize.sFixed64(element) }
    }

    if (this.repeatedFloat.isNotEmpty()) {
        __result += this.repeatedFloat.sumOf { element -> WireSize.tag(41, WireType.FIXED32) + WireSize.float(element) }
    }

    if (this.repeatedDouble.isNotEmpty()) {
        __result += this.repeatedDouble.sumOf { element -> WireSize.tag(42, WireType.FIXED64) + WireSize.double(element) }
    }

    if (this.repeatedBool.isNotEmpty()) {
        __result += this.repeatedBool.sumOf { element -> WireSize.tag(43, WireType.VARINT) + WireSize.bool(element) }
    }
    ...
    if (this.repeatedNestedEnum.isNotEmpty()) {
        __result += this.repeatedNestedEnum.sumOf { element -> WireSize.tag(51, WireType.VARINT) + WireSize.enum(element.number) }
    }

    if (this.repeatedForeignEnum.isNotEmpty()) {
        __result += this.repeatedForeignEnum.sumOf { element -> WireSize.tag(52, WireType.VARINT) + WireSize.enum(element.number) }
    }
...
fun ForeignMessageProto2Internal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    if (presenceMask[ForeignMessageProto2Internal.PresenceIndices.c]) {
...
fun GroupFieldInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    if (presenceMask[GroupFieldInternal.PresenceIndices.groupInt32]) {
        encoder.writeInt32(fieldNr = 122, value = this.groupInt32)
    }

    if (presenceMask[GroupFieldInternal.PresenceIndices.groupUint32]) {
        encoder.writeUInt32(fieldNr = 123, value = this.groupUint32)
    }
...
fun GroupFieldInternal.Companion.decodeWith(msg: GroupFieldInternal, decoder: WireDecoder, config: ProtoConfig?) {
    while (true) {
        val tag = decoder.readTag() ?: break // EOF, we read the whole message
        when (tag.fieldNr) {
            122 if tag.wireType == WireType.VARINT -> {
                msg.groupInt32 = decoder.readInt32()
            }
            123 if tag.wireType == WireType.VARINT -> {
...
private fun GroupFieldInternal.computeSize(): Int {
    var __result = 0
    if (presenceMask[GroupFieldInternal.PresenceIndices.groupInt32]) {
        __result += WireSize.tag(122, WireType.VARINT) + WireSize.int32(this.groupInt32)
    }

    if (presenceMask[GroupFieldInternal.PresenceIndices.groupUint32]) {
        __result += WireSize.tag(123, WireType.VARINT) + WireSize.uInt32(this.groupUint32)
    }
...
fun UnknownToTestAllTypesInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    if (presenceMask[UnknownToTestAllTypesInternal.PresenceIndices.optionalInt32]) {
        encoder.writeInt32(fieldNr = 1001, value = this.optionalInt32)
    }

    if (presenceMask[UnknownToTestAllTypesInternal.PresenceIndices.optionalString]) {
        encoder.writeString(fieldNr = 1002, value = this.optionalString)
    }

    if (presenceMask[UnknownToTestAllTypesInternal.PresenceIndices.nestedMessage]) {
        encoder.writeMessage(fieldNr = 1003, value = this.nestedMessage.asInternal()) { encoder -> encodeWith(encoder, config) }
    }

    if (presenceMask[UnknownToTestAllTypesInternal.PresenceIndices.optionalgroup]) {
        encoder.writeGroupMessage(fieldNr = 1004, value = this.optionalgroup.asInternal()) { encoder -> encodeWith(encoder, config) }
    }

    if (presenceMask[UnknownToTestAllTypesInternal.PresenceIndices.optionalBool]) {
        encoder.writeBool(fieldNr = 1006, value = this.optionalBool)
    }
...
fun UnknownToTestAllTypesInternal.Companion.decodeWith(msg: UnknownToTestAllTypesInternal, decoder: WireDecoder, config: ProtoConfig?) {
    while (true) {
        val tag = decoder.readTag() ?: break // EOF, we read the whole message
        when (tag.fieldNr) {
            1001 if tag.wireType == WireType.VARINT -> {
                msg.optionalInt32 = decoder.readInt32()
            }
            1002 if tag.wireType == WireType.LENGTH_DELIMITED -> {
                msg.optionalString = decoder.readString()
            }
            1003 if tag.wireType == WireType.LENGTH_DELIMITED -> {
                val target = msg.__nestedMessageDelegate.getOrCreate(msg) { ForeignMessageProto2Internal() }
                decoder.readMessage(target.asInternal()) { msg, decoder -> ForeignMessageProto2Internal.decodeWith(msg, decoder, config) }
            }
            1004 if tag.wireType == WireType.START_GROUP -> {
            ...
            1006 if tag.wireType == WireType.VARINT -> {
                msg.optionalBool = decoder.readBool()
            }
            1011 if tag.wireType == WireType.LENGTH_DELIMITED -> {
                val target = msg.__repeatedInt32Delegate.getOrCreate(msg) { mutableListOf() } as MutableList
                target.addAll(decoder.readPackedInt32())
            }
            1011 if tag.wireType == WireType.VARINT -> {
                val target = msg.__repeatedInt32Delegate.getOrCreate(msg) { mutableListOf() } as MutableList
                val elem = decoder.readInt32()
                target.add(elem)
            }
...
private fun UnknownToTestAllTypesInternal.computeSize(): Int {
    var __result = 0
    if (presenceMask[UnknownToTestAllTypesInternal.PresenceIndices.optionalInt32]) {
        __result += WireSize.tag(1001, WireType.VARINT) + WireSize.int32(this.optionalInt32)
    }

    if (presenceMask[UnknownToTestAllTypesInternal.PresenceIndices.optionalString]) {
        __result += WireSize.string(this.optionalString).let { WireSize.tag(1002, WireType.LENGTH_DELIMITED) + WireSize.int32(it) + it }
    }
    ...
    if (presenceMask[UnknownToTestAllTypesInternal.PresenceIndices.optionalBool]) {
        __result += WireSize.tag(1006, WireType.VARINT) + WireSize.bool(this.optionalBool)
    }

    if (this.repeatedInt32.isNotEmpty()) {
        __result += this.repeatedInt32.sumOf { element -> WireSize.tag(1011, WireType.VARINT) + WireSize.int32(element) }
    }
...
fun OneStringProto2Internal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    if (presenceMask[OneStringProto2Internal.PresenceIndices.data]) {
        encoder.writeString(fieldNr = 1, value = this.data)
    }
...
private fun OneStringProto2Internal.computeSize(): Int {
    var __result = 0
    if (presenceMask[OneStringProto2Internal.PresenceIndices.data]) {
        __result += WireSize.string(this.data).let { WireSize.tag(1, WireType.LENGTH_DELIMITED) + WireSize.int32(it) + it }
    }
...
fun ProtoWithKeywordsInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    if (presenceMask[ProtoWithKeywordsInternal.PresenceIndices.inline]) {
        encoder.writeInt32(fieldNr = 1, value = this.inline)
    }

    if (presenceMask[ProtoWithKeywordsInternal.PresenceIndices.concept]) {
        encoder.writeString(fieldNr = 2, value = this.concept)
    }
...
private fun ProtoWithKeywordsInternal.computeSize(): Int {
    var __result = 0
    if (presenceMask[ProtoWithKeywordsInternal.PresenceIndices.inline]) {
        __result += WireSize.tag(1, WireType.VARINT) + WireSize.int32(this.inline)
    }

    if (presenceMask[ProtoWithKeywordsInternal.PresenceIndices.concept]) {
        __result += WireSize.string(this.concept).let { WireSize.tag(2, WireType.LENGTH_DELIMITED) + WireSize.int32(it) + it }
    }

    if (this.requires.isNotEmpty()) {
        __result += this.requires.sumOf { element -> WireSize.string(element).let { WireSize.tag(3, WireType.LENGTH_DELIMITED) + WireSize.int32(it) + it } }
    }
...
fun TestAllRequiredTypesProto2Internal.checkRequiredFields() {
    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredInt32]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredInt32")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredInt64]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredInt64")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredUint32]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredUint32")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredUint64]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredUint64")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredSint32]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredSint32")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredSint64]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredSint64")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredFixed32]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredFixed32")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredFixed64]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredFixed64")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredSfixed32]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredSfixed32")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredSfixed64]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredSfixed64")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredFloat]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredFloat")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredDouble]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredDouble")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredBool]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredBool")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredString]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredString")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredBytes]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredBytes")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredNestedMessage]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredNestedMessage")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredForeignMessage]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredForeignMessage")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredNestedEnum]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredNestedEnum")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredForeignEnum]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredForeignEnum")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredStringPiece]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredStringPiece")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredCord]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "requiredCord")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.recursiveMessage]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "recursiveMessage")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.data]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "data")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultInt32]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultInt32")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultInt64]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultInt64")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultUint32]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultUint32")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultUint64]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultUint64")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultSint32]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultSint32")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultSint64]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultSint64")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultFixed32]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultFixed32")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultFixed64]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultFixed64")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultSfixed32]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultSfixed32")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultSfixed64]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultSfixed64")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultFloat]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultFloat")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultDouble]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultDouble")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultBool]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultBool")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultString]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultString")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.defaultBytes]) {
        throw ProtobufException.missingRequiredField("TestAllRequiredTypesProto2", "defaultBytes")
    }
...
fun TestAllRequiredTypesProto2Internal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredNestedMessage]) {
        encoder.writeMessage(fieldNr = 18, value = this.requiredNestedMessage.asInternal()) { encoder -> encodeWith(encoder, config) }
    }

    if (presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.requiredForeignMessage]) {
        encoder.writeMessage(fieldNr = 19, value = this.requiredForeignMessage.asInternal()) { encoder -> encodeWith(encoder, config) }
    }
    ...
    if (presenceMask[TestAllRequiredTypesProto2Internal.PresenceIndices.optionalRecursiveMessage]) {
        encoder.writeMessage(fieldNr = 28, value = this.optionalRecursiveMessage.asInternal()) { encoder -> encodeWith(encoder, config) }
    }
...
fun TestAllRequiredTypesProto2Internal.Companion.decodeWith(msg: TestAllRequiredTypesProto2Internal, decoder: WireDecoder, config: ProtoConfig?) {
    ...
    while (true) {
        ...
        when (tag.fieldNr) {
            ...
            28 if tag.wireType == WireType.LENGTH_DELIMITED -> {
...
fun TestAllTypesProto2Internal.NestedMessageInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.NestedMessageInternal.PresenceIndices.corecursive]) {
...
fun TestAllTypesProto2Internal.MapInt32Int32EntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapInt32Int32EntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapInt64Int64EntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapInt64Int64EntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapUint32Uint32EntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapUint32Uint32EntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapUint64Uint64EntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapUint64Uint64EntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapSint32Sint32EntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapSint32Sint32EntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapSint64Sint64EntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapSint64Sint64EntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapFixed32Fixed32EntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapFixed32Fixed32EntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapFixed64Fixed64EntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapFixed64Fixed64EntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapSfixed32Sfixed32EntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapSfixed32Sfixed32EntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapSfixed64Sfixed64EntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapSfixed64Sfixed64EntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapInt32BoolEntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapInt32BoolEntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapInt32FloatEntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapInt32FloatEntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapInt32DoubleEntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapInt32DoubleEntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapInt32NestedMessageEntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapInt32NestedMessageEntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapBoolBoolEntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapBoolBoolEntryInternal.PresenceIndices.value]) {
        encoder.writeBool(fieldNr = 2, value = this.value)
    }
...
fun TestAllTypesProto2Internal.MapStringStringEntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapStringStringEntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapStringBytesEntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapStringBytesEntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapStringNestedMessageEntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapStringNestedMessageEntryInternal.PresenceIndices.value]) {
        encoder.writeMessage(fieldNr = 2, value = this.value.asInternal()) { encoder -> encodeWith(encoder, config) }
    }
...
fun TestAllTypesProto2Internal.MapStringForeignMessageEntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapStringForeignMessageEntryInternal.PresenceIndices.value]) {
        encoder.writeMessage(fieldNr = 2, value = this.value.asInternal()) { encoder -> encodeWith(encoder, config) }
    }
...
fun TestAllTypesProto2Internal.MapStringNestedEnumEntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapStringNestedEnumEntryInternal.PresenceIndices.value]) {
...
fun TestAllTypesProto2Internal.MapStringForeignEnumEntryInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MapStringForeignEnumEntryInternal.PresenceIndices.value]) {
        encoder.writeEnum(fieldNr = 2, value = this.value.number)
    }
...
fun TestAllTypesProto2Internal.DataInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    if (presenceMask[TestAllTypesProto2Internal.DataInternal.PresenceIndices.groupInt32]) {
        encoder.writeInt32(fieldNr = 202, value = this.groupInt32)
    }

    if (presenceMask[TestAllTypesProto2Internal.DataInternal.PresenceIndices.groupUint32]) {
...
fun TestAllTypesProto2Internal.MultiWordGroupFieldInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllTypesProto2Internal.MultiWordGroupFieldInternal.PresenceIndices.groupUint32]) {
        encoder.writeUInt32(fieldNr = 206, value = this.groupUint32)
    }
...
fun TestAllTypesProto2Internal.MultiWordGroupFieldInternal.Companion.decodeWith(msg: TestAllTypesProto2Internal.MultiWordGroupFieldInternal, decoder: WireDecoder, config: ProtoConfig?, startGroup: KTag?) {
    while (true) {
        ...
        when (tag.fieldNr) {
            205 if tag.wireType == WireType.VARINT -> {
                msg.groupInt32 = decoder.readInt32()
            }
            206 if tag.wireType == WireType.VARINT -> {
                msg.groupUint32 = decoder.readUInt32()
            }
            else -> {
                if (config?.discardUnknownFields ?: false) {
...
private fun TestAllTypesProto2Internal.MultiWordGroupFieldInternal.computeSize(): Int {
    var __result = 0
    if (presenceMask[TestAllTypesProto2Internal.MultiWordGroupFieldInternal.PresenceIndices.groupInt32]) {
        __result += WireSize.tag(205, WireType.VARINT) + WireSize.int32(this.groupInt32)
    }

    if (presenceMask[TestAllTypesProto2Internal.MultiWordGroupFieldInternal.PresenceIndices.groupUint32]) {
        __result += WireSize.tag(206, WireType.VARINT) + WireSize.uInt32(this.groupUint32)
    }
...
fun TestAllRequiredTypesProto2Internal.NestedMessageInternal.checkRequiredFields() {
    if (!presenceMask[TestAllRequiredTypesProto2Internal.NestedMessageInternal.PresenceIndices.a]) {
        throw ProtobufException.missingRequiredField("NestedMessage", "a")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.NestedMessageInternal.PresenceIndices.corecursive]) {
        throw ProtobufException.missingRequiredField("NestedMessage", "corecursive")
    }
...
fun TestAllRequiredTypesProto2Internal.NestedMessageInternal.encodeWith(encoder: WireEncoder, config: ProtoConfig?) {
    ...
    if (presenceMask[TestAllRequiredTypesProto2Internal.NestedMessageInternal.PresenceIndices.optionalCorecursive]) {
        encoder.writeMessage(fieldNr = 3, value = this.optionalCorecursive.asInternal()) { encoder -> encodeWith(encoder, config) }
    }
...
fun TestAllRequiredTypesProto2Internal.DataInternal.checkRequiredFields() {
    if (!presenceMask[TestAllRequiredTypesProto2Internal.DataInternal.PresenceIndices.groupInt32]) {
        throw ProtobufException.missingRequiredField("Data", "groupInt32")
    }

    if (!presenceMask[TestAllRequiredTypesProto2Internal.DataInternal.PresenceIndices.groupUint32]) {
        throw ProtobufException.missingRequiredField("Data", "groupUint32")
    }
}
...
fun TestAllRequiredTypesProto2Internal.MessageSetCorrectExtension1Internal.checkRequiredFields() {
    if (!presenceMask[TestAllRequiredTypesProto2Internal.MessageSetCorrectExtension1Internal.PresenceIndices.str]) {
        throw ProtobufException.missingRequiredField("MessageSetCorrectExtension1", "str")
    }
}
...
fun TestAllRequiredTypesProto2Internal.MessageSetCorrectExtension2Internal.checkRequiredFields() {
    if (!presenceMask[TestAllRequiredTypesProto2Internal.MessageSetCorrectExtension2Internal.PresenceIndices.i]) {
        throw ProtobufException.missingRequiredField("MessageSetCorrectExtension2", "i")
    }
}
