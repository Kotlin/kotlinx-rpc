...
class TransportTest {
    ...
    private val serverConfig = rpcServerConfig {
        ...
        connector {
            // todo try with size 10, see logs and an error and check that test fails?
            perCallBufferSize = 100
        }
    }
    ...
    ): TestResult = kotlinx.coroutines.test.runTest(timeout = 60.seconds) {
        debugCoroutines()
